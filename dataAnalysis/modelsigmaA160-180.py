...
# -*- coding: utf-8 -*-
"""
Created on Tue May  5 14:29:01 2020
...
#    Dname='modelDCE0-3fixNSD0.04N551210.000051064.h5' #best
...
#    Dname='modelDCE0-3A160-180fixNSD0.04N551210.0000510128.h5'
#    Dname='modelDCE0-3A160-180fixNSD0.04N551210.000051064.h5'
    Dname='modelDCE0-3A160-180fixNSD0.04N551210.000051032.h5'
    name='CE0-3A160-180fixNSC208M2C104M2D0.1N5150010.00120256'
#    name='CE0-3A160-180fixNSC208M2C104M2D0.1N5150010.00120128'
#
    titlestring='Energy resolution 0-3 GeV Ang 160-180 sim hits'
...
#    np.save('E0-3GeVlinfitcovarmatrix.npy',linpcov)
    linpopt=np.load('E0-3GeVAng160-180linfitkm.npy')
    linpcov=np.load('E0-3GeVAng160-180linfitcovarmatrix.npy')
...
#        data_entries,bins,temp=plt.hist(ydeltatest,bins=100,range=Drangelist[i]) 
    ...
    plt.errorbar(xlist,ylist,yerr=ylisterr,fmt='^',capsize=5,color='navy',label='CNN(AS2)')
